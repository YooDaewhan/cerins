        ...
        <div className="flex flex-col lg:flex-row gap-10">
          ...
          <aside className="lg:w-56 flex-shrink-0">
            ...
            <div className="mt-4 border border-gray-100 rounded-lg p-4 bg-white">
              ...
              <Link
                href="/contact"
                className="block text-center text-xs font-semibold text-white bg-[var(--brand)] px-4 py-2 rounded hover:bg-[#0d2a5a] transition"
              >
                Contact Us
              </Link>
            </div>
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="mt-8 pt-6 border-t border-gray-100">
              <Link href="/inspection" className="text-sm text-gray-400 hover:text-[var(--brand)] transition flex items-center gap-1">
