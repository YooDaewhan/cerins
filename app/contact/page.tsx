      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
          ...
          <div className="space-y-8">
            <div>
              <div className="flex items-center gap-3 mb-3">
                <div className="w-6 h-0.5 bg-[#B4123A]" />
                <span className="text-xs font-bold text-[#B4123A] uppercase tracking-widest">Get In Touch</span>
              </div>
              <h2 className="text-2xl font-bold text-[#0a1f44] mb-3">We&apos;d love to hear from you</h2>
            ...
            <div className="border-t border-gray-100 pt-6 space-y-4">
              ...
              <div>
                <p className="text-sm font-semibold text-[#0a1f44]">Moscow, Russia</p>
                <p className="text-xs text-gray-500">45 Tverskaya Street, Moscow 125009</p>
              </div>
              <div>
                <p className="text-sm font-semibold text-[#0a1f44]">Ho Chi Minh City, Vietnam</p>
          ...
          <div className="lg:col-span-2 bg-white border border-gray-100 shadow-sm rounded-xl p-8">
            <div className="mb-6">
              <h3 className="text-lg font-bold text-[#0a1f44]">Send a Message</h3>
...
function ContactInfoItem({ icon, label, lines }: { icon: string; label: string; lines: string[] }) {
  ...
  return (
    <div className="flex gap-3">
      <div className="text-[#B4123A] flex-shrink-0 mt-0.5">{iconMap[icon]}</div>
      <div>
