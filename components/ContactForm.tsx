...
export default function ContactForm() {
  ...
  const inputClass =
    "w-full border border-gray-200 rounded px-4 py-3 text-sm text-gray-800 placeholder-gray-400 focus:outline-none focus:border-[#0a1f44] transition";
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-5">
      ...
      <button
        type="submit"
        className="w-full sm:w-auto px-8 py-3 bg-[#0a1f44] text-white text-sm font-semibold rounded hover:bg-[#0d2a5a] transition"
      >
        Send Message
      </button>
    </form>
